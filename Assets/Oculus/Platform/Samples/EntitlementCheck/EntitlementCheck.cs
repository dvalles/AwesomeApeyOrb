...
namespace Oculus.Platform.Samples.EntitlementCheck
{
  public class EntitlementCheck : MonoBehaviour
  {
    ...
    //grab their oculus ID
    private void GetLoggedInUserCallback(Message<Oculus.Platform.Models.User> message)
    {
        if (!message.IsError)
        {
            oculusID = message.Data.ID.ToString();
            Debug.Log("Oculus ID: " + oculusID);
        }
    }
